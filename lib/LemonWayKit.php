...
class LemonWayKit{
	...
	private static $accessConfig = array (
							'directKitUrl' => 'https://ws.lemonway.fr/mb/avekapeti/dev/directkit/service.asmx',
							'webkitUrl' => 'https://m.lemonway.fr/mb/avekapeti/dev/',
							'wlLogin' => 'society',
							'wlPass' => '123456',
							'language' => 'fr');
	...
	private static function printDirectkitInput($string){
		if (self::$printInputAndOutputXml){
	...
	private static function sendRequest($methodName, $params, $version){
		$ua = '';
	...
	public static function printCardForm($moneyInToken, $cssUrl = '', $language = 'fr'){
		$ch = curl_init();
